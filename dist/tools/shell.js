...
export const runShellTool = {
    name: 'run_shell',
    description: 'Execute a shell command. Destructive patterns (rm -rf /, mkfs, dd to disks, shutdown, fork bombs, curl|sh, etc.) are blocked. In interactive mode the user is asked to confirm; in daemon mode AUTO_RUN_SHELL controls behaviour.',
