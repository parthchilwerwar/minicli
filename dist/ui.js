...
class Spinner {
    ...
    stop(finalLine) {
        ...
        if (finalLine)
            process.stdout.write('  ' + DIM(finalLine) + '\n');
    }
}
...
// ─── REPL prompts ─────────────────────────────────────────────────────────────
export function userPromptLabel() {
    return '\n  ' + LIME('>') + '  ';
}
export function aiPrefix() {
    process.stdout.write('\n  ' + DIM('ai') + '  ');
}
...
// ─── Streaming ────────────────────────────────────────────────────────────────
export function streamPrint(chunk) {
...
export function toolStart(name) {
    const label = TOOL_LABELS[name] ?? name.replace(/_/g, ' ');
    getSpinner().start(label);
}
export function toolDone(_result) {
    getSpinner().stop();
}
// ─── Confirm prompt ───────────────────────────────────────────────────────────
export async function confirmPrompt(msg) {
